...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('payment_process_records', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('payment_process_id')->comment('关联外键');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('payment_process_records');
    }
};
